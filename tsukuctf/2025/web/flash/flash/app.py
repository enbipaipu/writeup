...
SESSION_ID = "07860ff4ad083c5913c362bb45b487b6"
...
def result():
    ...
    if (
        "result_token" not in session
        or form_token != session["result_token"]
    ...
    resp = make_response(
        render_template(
            ...
            submitted=ans,
            correct=correct_sum,
            success=(ans == correct_sum),
            FLAG=FLAG if ans == correct_sum else None,
        )
    )
